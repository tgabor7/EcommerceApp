...
describe("Password validation", () => {
    ...
    test("Password should pass validation", ()=>{
        expect(validatePassword("a12356")).toBe(true)
        expect(validatePassword("a1235612")).toBe(true)
        expect(validatePassword("a123564235435")).toBe(true)
    })
})
